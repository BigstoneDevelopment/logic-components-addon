...
data modify storage bigstone_sandbox:components args.inputs_and_outputs set value [{text:"IBIN",italic:true,color:"dark_gray"},{text:"OBIN",italic:true,color:"dark_gray"}]
